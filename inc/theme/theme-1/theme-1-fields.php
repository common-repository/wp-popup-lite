    ...
    <div class="wpb-default-setting-group-wrapper">
        ...
        <div class="wpb-default-setting-field-wrapper" id='wpb-basic-layout-setting'>
            ...
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
                    <label>
                        <h4><?php echo __('Left Section Main Image', 'wp-popup-lite') ?></h4>
                    </label>
                </div>
                <div class="wpb-input-field">
            ...
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                ...
                <div class="wpb-input-field">
                    <input type="text" id="wpb-header-text" name="buildin_theme[wpb_header_text]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_header_text']); ?>" placeholder="<?php echo __('Want a Free Pass', 'wp-popup-lite'); ?>">
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
                ...
                <div class="wpb-input-field-inner">
                    <div class="wpb-input-field">
                        <select name="buildin_theme[wpb_header_typography]" id="wpb-header-font-family">
                            ...
                            <?php foreach (get_option('wpb_typo_fonts') as $wpb_fonts) { ?>
                                <option value="<?php echo $wpb_fonts; ?>" <?php
                                if (isset($buildin_theme['buildin_popup']['wpb_header_typography']) && $buildin_theme['buildin_popup']['wpb_header_typography'] == $wpb_fonts) {
                                    echo 'selected="selected"';
                                }
                                ?>><?php echo $wpb_fonts; ?></option>
                                    <?php } ?>
                        </select>
                    </div>
                    <div class="wpb-input-field">
                        <input type="number" id="wpb-popup-header-font-size" name="buildin_theme[wpb_header_text_font_size]" value="<?php echo isset($buildin_theme['buildin_popup']['wpb_header_text_font_size'])&& !empty($buildin_theme['buildin_popup']['wpb_header_text_font_size'])?esc_attr($buildin_theme['buildin_popup']['wpb_header_text_font_size']):'35'; ?>"><?php echo __('px', 'wp-popup-lite') ?>
                    </div>
                    <div class="wpb-input-field">
            ...
            <div class="wpb-input-field-wrap" id="wpb-popup-position">
                ...
                <div class="wpb-input-field">
                    <input type="text" id="wpb-popup-sub-header-text" name="buildin_theme[wpb_subheader_text]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_subheader_text']); ?>" placeholder="<?php echo __('Subscribe Now', 'wp-popup-lite'); ?>">
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
                ...
                <div class="wpb-input-field-inner">
                    ...
                    <div class="wpb-input-field">
                        <input type="number" id="wpb-popup-header-font-size" name="buildin_theme[wpb_subheader_text_font_size]" value="<?php echo isset($buildin_theme['buildin_popup']['wpb_subheader_text_font_size']) && !empty($buildin_theme['buildin_popup']['wpb_subheader_text_font_size']) ? esc_attr($buildin_theme['buildin_popup']['wpb_subheader_text_font_size']) : '32'; ?>"><?php echo __('px', 'wp-popup-lite') ?>
                    </div>
                    <div class="wpb-input-field">
            ...
            <div class="wpb-input-field-wrap" id="wpb-popup-background-field">
                ...
                <div class="wpb-input-field">
                    <input type="text" id="wpb-email-label-text" name="buildin_theme[wpb_secondary_subheader_text]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_secondary_subheader_text']); ?>" placeholder="<?php echo __('Join our mailing list..', 'wp-popup-lite'); ?>">
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
                ...
                <div class="wpb-input-field-inner">
                    ...
                    <div class="wpb-input-field">
                        <input type="number" id="wpb-popup-header-font-size" name="buildin_theme[wpb_secondary_subheader_font_size]" value="<?php echo isset($buildin_theme['buildin_popup']['wpb_secondary_subheader_font_size']) && !empty($buildin_theme['buildin_popup']['wpb_secondary_subheader_font_size']) ? esc_attr($buildin_theme['buildin_popup']['wpb_secondary_subheader_font_size']) : ''; ?>"><?php echo __('px', 'wp-popup-lite') ?>
                    </div>
                    <div class="wpb-input-field">
            ...
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                ...
                <div class="wpb-input-field-inner">
                    <div class="wpb-input-field">
                        <select name="buildin_theme[wpb_email_placeholder_typography]" id="wpb-inner-email-label-font-family">
                            <option value="default"><?php _e('Default', 'wp-popup-lite'); ?></option>
                            <?php foreach (get_option('wpb_typo_fonts') as $wpb_font) { ?>
                                <option value="<?php echo $wpb_font; ?>" <?php
            ...
            <div class="wpb-input-field-wrap">
                ...
                <div class="wpb-input-field">
                    <input type="text" class="buildin-default-font-color" id="wpb-popup-email-icon-font-color" name="buildin_theme[wpb_email_icon_color]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_email_icon_color']); ?>">
                </div>
            </div>
            ...
            <div class="wpb-input-field-wrap" id="wpb-popup-shape">
                <div class="wpb-input-field-title">
                    <label>
                        <h4><?php echo __('Security Text', 'wp-popup-lite') ?></h4>
                    </label>
                </div>
                <div class="wpb-input-field">
                    <input type="text" id="wpb-submit-button-text" name="buildin_theme[wpb_security_text]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_security_text']); ?>" placeholder="<?php echo __('We hate spam as much...', 'wp-popup-lite'); ?>">
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
                    <label>
                        <h4><?php echo __('Security Text Typography', 'wp-popup-lite') ?></h4>
                    </label>
                </div>
                <div class="wpb-input-field-inner">
                    <div class="wpb-input-field">
                        <select name="buildin_theme[wpb_security_text_typography]" id="wpb-inner-security-text-font-family">
                            <option value="default"><?php _e('Default', 'wp-popup-lite'); ?></option>
                            <?php foreach (get_option('wpb_typo_fonts') as $wpb_font) { ?>
                                <option value="<?php echo $wpb_font; ?>" <?php
                                if (isset($buildin_theme['buildin_popup']['wpb_security_text_typography']) && $buildin_theme['buildin_popup']['wpb_security_text_typography'] == $wpb_font) {
                                    echo 'selected="selected"';
                                }
                                ?>><?php echo $wpb_font; ?></option>
                                    <?php } ?>
                    ...
                    <!--<div class="wpb-input-field">
                        <input type="text" id="wpb-security-text-font-size" name="buildin_theme[wpb_security_text_font_size]" value="<?php echo isset($buildin_theme['buildin_popup']['wpb_security_text_font_size']) && !empty($buildin_theme['buildin_popup']['wpb_security_text_font_size']) ? esc_attr($buildin_theme['buildin_popup']['wpb_security_text_font_size']) : '14'; ?>" ><?php echo __('px', 'wp-popup-lite') ?>
                    </div>-->
                    <div class="wpb-input-field">
                        <input type="text" class="buildin-default-font-color" id="wpb-popup-security-text-font-color" name="buildin_theme[wpb_security_text_font_color]" value="<?php echo isset($buildin_theme['buildin_popup']['wpb_security_text_font_color']) && !empty($buildin_theme['buildin_popup']['wpb_security_text_font_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_security_text_font_color']) : ''; ?>">
                    </div>
                </div>
            </div>
        </div>
