...
if (isset($buildin_theme['buildin_popup']['wpb_couponcode_typography']) && $buildin_theme['buildin_popup']['wpb_couponcode_typography'] != 'default') {
    $fonts_final = str_replace(' ', '+', $buildin_theme['buildin_popup']['wpb_couponcode_typography']);
    echo "<link rel='stylesheet' id='wpb-google-fonts-style-css' href='//fonts.googleapis.com/css?family=" . $fonts_final . "' type='text/css' media='all' />";
}
...
<div class="wpb-outer-wrap wpb-default-popup-layout wpb-<?php echo $wpb_buildin_theme_type; ?>" id="wpb-outer-wrap-<?php echo esc_attr($popup_id); ?>" data-popup-id="<?php echo esc_attr($popup_id); ?>" 
    ...
    <style type="text/css">
        ...
        <?php } ?>
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme36-wrapper{
            ...
            <?php echo isset($buildin_theme['buildin_popup']['wpb_builtin_rightbg_image']) && !empty($buildin_theme['buildin_popup']['wpb_builtin_rightbg_image']) ? 'background-image:url(' . esc_attr($buildin_theme['buildin_popup']['wpb_builtin_rightbg_image']) . ');' : ''; ?>
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme36-wrapper .wpb-left-content-title{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme36-wrapper .wpb-left-content-subtitle{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme36-wrapper .wpb-left-desc{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme36-wrapper input.wpb-email-field{
            -webkit-animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 0.5) : 1.5; ?>s; /* Safari 4.0 - 8.0 */
            animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 0.5) : 1.5; ?>s;
            animation-duration:1s; 
            -webkit-animation-duration: 1s; /* Safari 4.0 - 8.0 */
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme36-wrapper .wpb-theme36-form input[type="text"]::-moz-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme36-wrapper .wpb-theme36-form input[type="text"]{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme36-wrapper .wpb-theme36-form input[type="text"]:-ms-input-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme36-wrapper .wpb-theme36-form input[type="text"]{
            font-family:<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) : ''; ?>;
            color:<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) . '!important' : ''; ?>;
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme36-wrapper .wpb-theme36-form input[type="text"]::-webkit-input-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme36-wrapper .wpb-theme36-form input[type="text"]{
            font-family:<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) : ''; ?>;
            color:<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) . '!important' : ''; ?> ;
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme36-wrapper .wpb-left-coupon-btn{
            background-color:<?php echo isset($buildin_theme['buildin_popup']['wpb_couponcode_bg_color']) && !empty($buildin_theme['buildin_popup']['wpb_couponcode_bg_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_couponcode_bg_color']) : ''; ?>;     
            font-family:<?php echo isset($buildin_theme['buildin_popup']['wpb_couponcode_typography']) && !empty($buildin_theme['buildin_popup']['wpb_couponcode_typography']) ? esc_attr($buildin_theme['buildin_popup']['wpb_couponcode_typography']) : ''; ?>;
            color:<?php echo isset($buildin_theme['buildin_popup']['wpb_couponcode_font_color']) && !empty($buildin_theme['buildin_popup']['wpb_couponcode_font_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_couponcode_font_color']) : ''; ?>;  
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme36-wrapper .wpb-theme36-form .wpb-subscribe-button{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme-36 .wpb_close_btn.wpb-close-option:after{
            color:<?php echo isset($parameteres['popup_parameters']['wpb_close_icon_bg_color']) && !empty($parameteres['popup_parameters']['wpb_close_icon_bg_color']) ? esc_attr($parameteres['popup_parameters']['wpb_close_icon_bg_color']) : ''; ?>;    
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme36-wrapper .wpb-theme36-form .wpb-button2{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme36-wrapper .wpb-fe-form-field.required.wpb-input-field-error{
        ...
        <div class="wpb-main-inner-wrap animated <?php echo $wpb_popup_animation_option; ?>">
            ...
            <div class="wpb-inner-wrapper" style="position:relative;"> 
                <div class="wpb-popup-content">
                    ...
                    ?>">
                        <div class="wpb-theme36-wrapper">
                            <div class="wpb-theme36-inner-wrapper clearfix">
                                <div class="wpb-left-content">
                                    <div class="wpb-left-inner-content animated fadeInDown">
                                        <p class="wpb-left-content-title">
                                            <?php echo isset($buildin_theme['buildin_popup']['wpb_header_text']) && !empty($buildin_theme['buildin_popup']['wpb_header_text']) ? esc_attr($buildin_theme['buildin_popup']['wpb_header_text']) : ''; ?>
                                            <span class="wpb-left-content-subtitle "><?php echo isset($buildin_theme['buildin_popup']['wpb_subheader_text']) && !empty($buildin_theme['buildin_popup']['wpb_subheader_text']) ? esc_attr($buildin_theme['buildin_popup']['wpb_subheader_text']) : '' ?></span>
                                        </p>
                                        <p class="wpb-left-desc"><?php echo isset($buildin_theme['buildin_popup']['wpb_secondary_subheader_text']) && !empty($buildin_theme['buildin_popup']['wpb_secondary_subheader_text']) ? esc_attr($buildin_theme['buildin_popup']['wpb_secondary_subheader_text']) : '' ?></p>
                                        <span class="wpb-coupon-clip wpb-left-coupon-btn animated fadeInDown"><?php echo isset($buildin_theme['buildin_popup']['wpb_coupon_code_text']) && !empty($buildin_theme['buildin_popup']['wpb_coupon_code_text']) ? esc_attr($buildin_theme['buildin_popup']['wpb_coupon_code_text']) : '' ?></span>                                                               
                                    </div>
                                </div>
                                <div class="wpb-right-content">
                                    <div class="wpb-right-image-wrap">
                                        <?php if (isset($buildin_theme['buildin_popup']['wpb_builtin_main_image']) && !empty($buildin_theme['buildin_popup']['wpb_builtin_main_image'])) { ?>
                                            <img src="<?php echo isset($buildin_theme['buildin_popup']['wpb_builtin_main_image']) && !empty($buildin_theme['buildin_popup']['wpb_builtin_main_image']) ? esc_url($buildin_theme['buildin_popup']['wpb_builtin_main_image']) : WPP_IMAGE_DIR . '/coupon-1-logo.png'; ?>" alt="<?php echo isset($buildin_theme['buildin_popup']['wpb_header_text']) && !empty($buildin_theme['buildin_popup']['wpb_header_text']) ? esc_attr($buildin_theme['buildin_popup']['wpb_header_text']) : ''; ?>"/>
                                        <?php } ?>
                                    </div>
                                    <div class="wpb-theme36-form">
                                        <div class="wpb-right-input-field">
                                            <div class="wpb-single-input-wrap clearfix">                                            
                                                <div class="wpb-email-field-wrap">
                                                    <input class="wpb-email-field wpb-fe-form-field required animated fadeInLeft" type="text" name="wpb_email_address" placeholder="<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder']) : ''; ?>">
                                                </div>
                                                <div class="wpb-right-button-wrap">
                                                    <button type="submit" class="wpb-subscribe-button animated fadeInRight <?php
                                                    ...
                                                    <button class="wpb-button2 wpb_close_btn animated fadeInDown"><?php echo isset($buildin_theme['buildin_popup']['wpb_no_thanks_text']) && !empty($buildin_theme['buildin_popup']['wpb_no_thanks_text']) ? esc_attr($buildin_theme['buildin_popup']['wpb_no_thanks_text']) : ''; ?></button>
                                                </div>
                                            </div>                                                                                                  
                                        </div>
                                    </div> 
