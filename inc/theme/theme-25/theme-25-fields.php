    ...
    <div class="wpb-default-setting-group-wrapper">
        ...
        <div class="wpb-default-setting-field-wrapper" id='wpb-basic-layout-setting'>
            ...
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
                    <label>
                        <h4><?php echo __('Google Map Embed', 'wp-popup-lite') ?></h4>
                    </label>
                </div>
                <div class="wpb-input-field">
                    <textarea class="buildin-default-google-embed" id="wpb-upload-builtin-google-embed" type="text" name="buildin_theme_google_embed[wpb_builtin_google_map_embed]"><?php echo esc_attr($buildin_theme['buildin_theme_google_embed']['wpb_builtin_google_map_embed']); ?></textarea>
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
            ...
            <div class="wpb-input-field-wrap" id="wpb-popup-position">
                ...
                <div class="wpb-input-field">
                    <input type="text" id="wpb-popup-sub-header-text" name="buildin_theme[wpb_subheader_text]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_subheader_text']); ?>" placeholder="<?php echo __('Get information and...', 'wp-popup-lite'); ?>">
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
            ...
            <div class="wpb-input-field-wrap" id="wpb-popup-background-field">
                <div class="wpb-input-field-title">
                    <label>
                        <h4><?php echo __('Name Label Text', 'wp-popup-lite'); ?></h4>
                    </label>
                </div>
                <div class="wpb-input-field">
            ...
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                ...
                <div class="wpb-input-field-inner">
                    ...
                    <div class="wpb-input-field">
                        <input type="text" class="buildin-default-font-color" id="wpb-popup-email-label-font-color" name="buildin_theme[wpb_name_label_font_color]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_name_label_font_color']); ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="wpb-input-field-wrap" id="wpb-popup-shape">
                ...
                <div class="wpb-input-field">
                    <input type="text" id="wpb-submit-button-text" name="buildin_theme[wpb_submit_text]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_submit_text']); ?>" placeholder="<?php echo __('Submit', 'wp-popup-lite'); ?>">
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
            ...
            <div class="wpb-input-field-wrap" id="wpb-popup-shape">
                <div class="wpb-input-field-title">
                    <label>
                        <h4><?php echo __('Cancel Text', 'wp-popup-lite') ?></h4>
                    </label>
                </div>
                <div class="wpb-input-field">
                    <input type="text" id="wpb-submit-button-text" name="buildin_theme[wpb_no_thanks_text]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_no_thanks_text']); ?>" placeholder="<?php echo __('No Thanks', 'wp-popup-lite'); ?>">
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
                    <label>
                        <h4><?php echo __('Cancel Text Typography', 'wp-popup-lite') ?></h4>
                    </label>
                </div>
                <div class="wpb-input-field-inner">
                    <div class="wpb-input-field">
                    ...
                    <div class="wpb-input-field">
                        <input type="text" class="buildin-default-font-color" id="wpb-popup-email-label-font-color" name="buildin_theme[wpb_nothanks_text_font_color]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_nothanks_text_font_color']); ?>">
                    </div>
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
                    <label>
                        <h4><?php echo __('Cancel Text Background Color', 'wp-popup-lite') ?></h4>
                    </label>
                </div>
                <div class="wpb-input-field">
                    <input type="text" class="buildin-default-font-color" id="wpb-popup-no-thanks-background" name="buildin_theme[wpb_nothanks_bg]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_nothanks_bg']); ?>">
                </div>
            </div>
        </div>
    </div>
