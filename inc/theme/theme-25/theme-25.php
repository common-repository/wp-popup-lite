...
if (isset($buildin_theme['buildin_popup']['wpb_nothanks_text_typography']) && $buildin_theme['buildin_popup']['wpb_nothanks_text_typography'] != 'default') {
    $fonts_final = str_replace(' ', '+', $buildin_theme['buildin_popup']['wpb_nothanks_text_typography']);
    echo "<link rel='stylesheet' id='wpb-google-fonts-style-css' href='//fonts.googleapis.com/css?family=" . $fonts_final . "' type='text/css' media='all' />";
}
...
<div class="wpb-outer-wrap wpb-default-popup-layout wpb-<?php echo $wpb_buildin_theme_type; ?>" id="wpb-outer-wrap-<?php echo esc_attr($popup_id); ?>" data-popup-id="<?php echo esc_attr($popup_id); ?>" 
    ...
    <style type="text/css">
        ...
        <?php } ?>
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25-wrapper .wpb-left-content{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25-wrapper .wpb-left-content-title{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25-wrapper .wpb-left-content-desc{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25-wrapper #wpb-right-input-name-label label{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25-wrapper #wpb-right-input-email-label label{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25-wrapper #wpb-right-input-message-label label{
            ...
            -webkit-animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 0.8) : 1.8; ?>s; /* Safari 4.0 - 8.0 */
            animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 0.8) : 1.8; ?>s;
            animation-duration:1s; 
            -webkit-animation-duration: 1s; /* Safari 4.0 - 8.0 */
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25-wrapper input.wpb-name-field{
            -webkit-animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 0.6) : 1.6; ?>s; /* Safari 4.0 - 8.0 */
            animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 0.6) : 1.6; ?>s;
            animation-duration:1s; 
            -webkit-animation-duration: 1s; /* Safari 4.0 - 8.0 */
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25-wrapper input.wpb-email-field{
            -webkit-animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 0.7) : 1.7; ?>s; /* Safari 4.0 - 8.0 */
            animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 0.7) : 1.7; ?>s;
            animation-duration:1s; 
            -webkit-animation-duration: 1s; /* Safari 4.0 - 8.0 */
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25-wrapper textarea.wpb-message-field{
            -webkit-animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 0.8) : 1.8; ?>s; /* Safari 4.0 - 8.0 */
            animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 0.8) : 1.8; ?>s;
            animation-duration:1s; 
            -webkit-animation-duration: 1s; /* Safari 4.0 - 8.0 */
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25-wrapper .wpb-theme25-form input[type="text"].wpb-name-field::-moz-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25-wrapper .wpb-theme25-form input[type="text"].wpb-name-field{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25-wrapper .wpb-theme25-form input[type="text"].wpb-name-field:-ms-input-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25-wrapper .wpb-theme25-form input[type="text"].wpb-name-field{
            font-family:<?php echo isset($buildin_theme['buildin_popup']['wpb_name_placeholder_typography']) && !empty($buildin_theme['buildin_popup']['wpb_name_placeholder_typography']) ? esc_attr($buildin_theme['buildin_popup']['wpb_name_placeholder_typography']) : ''; ?>;
            color:<?php echo isset($buildin_theme['buildin_popup']['wpb_name_placeholder_font_color']) && !empty($buildin_theme['buildin_popup']['wpb_name_placeholder_font_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_name_placeholder_font_color']) . '!important' : ''; ?>;
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25-wrapper .wpb-theme25-form input[type="text"].wpb-name-field::-webkit-input-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25-wrapper .wpb-theme25-form input[type="text"].wpb-name-field{
            font-family:<?php echo isset($buildin_theme['buildin_popup']['wpb_name_placeholder_typography']) && !empty($buildin_theme['buildin_popup']['wpb_name_placeholder_typography']) ? esc_attr($buildin_theme['buildin_popup']['wpb_name_placeholder_typography']) : ''; ?>;
            color:<?php echo isset($buildin_theme['buildin_popup']['wpb_name_placeholder_font_color']) && !empty($buildin_theme['buildin_popup']['wpb_name_placeholder_font_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_name_placeholder_font_color']) . '!important' : ''; ?>;
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25-wrapper .wpb-theme25-form input[type="text"].wpb-email-field::-moz-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25-wrapper .wpb-theme25-form input[type="text"].wpb-email-field{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25-wrapper .wpb-theme25-form input[type="text"].wpb-email-field:-ms-input-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25-wrapper .wpb-theme25-form input[type="text"].wpb-email-field{
            font-family:<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) : ''; ?>;
            color:<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) . '!important' : ''; ?>;
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25-wrapper .wpb-theme25-form input[type="text"].wpb-email-field::-webkit-input-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25-wrapper .wpb-theme25-form input[type="text"].wpb-email-field{
            font-family:<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) : ''; ?>;
            color:<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) . '!important' : ''; ?>;
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25-wrapper .wpb-theme25-form textarea.wpb-message-field::-webkit-input-placeholder,  
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25-wrapper .wpb-theme25-form textarea.wpb-message-field{
            font-family:<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) : ''; ?>;
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25-wrapper .wpb-theme25-form textarea.wpb-message-field::-moz-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25-wrapper .wpb-theme25-form textarea.wpb-message-field{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25-wrapper .wpb-theme25-form textarea.wpb-message-field:-ms-input-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25-wrapper .wpb-theme25-form textarea.wpb-message-field{ 
            font-family:<?php echo isset($buildin_theme['buildin_popup']['wpb_message_placeholder_typography']) && !empty($buildin_theme['buildin_popup']['wpb_message_placeholder_typography']) ? esc_attr($buildin_theme['buildin_popup']['wpb_message_placeholder_typography']) : ''; ?>;
            color:<?php echo isset($buildin_theme['buildin_popup']['wpb_message_placeholder_font_color']) && !empty($buildin_theme['buildin_popup']['wpb_message_placeholder_font_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_message_placeholder_font_color']) . '!important' : ''; ?> ;   
        } 
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25-wrapper .wpb-theme25-form textarea.wpb-message-field:-o-input-placeholder, 
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25-wrapper .wpb-theme25-form textarea.wpb-message-field{ 
            font-family:<?php echo isset($buildin_theme['buildin_popup']['wpb_message_placeholder_typography']) && !empty($buildin_theme['buildin_popup']['wpb_message_placeholder_typography']) ? esc_attr($buildin_theme['buildin_popup']['wpb_message_placeholder_typography']) : ''; ?>;
            color:<?php echo isset($buildin_theme['buildin_popup']['wpb_message_placeholder_font_color']) && !empty($buildin_theme['buildin_popup']['wpb_message_placeholder_font_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_message_placeholder_font_color']) . '!important' : ''; ?> ;   
        }  
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25-wrapper .wpb-subscribe-button{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25-wrapper .wpb-cancel-btn{
            font-family:<?php echo isset($buildin_theme['buildin_popup']['wpb_nothanks_text_typography']) && !empty($buildin_theme['buildin_popup']['wpb_nothanks_text_typography']) ? esc_attr($buildin_theme['buildin_popup']['wpb_nothanks_text_typography']) : ''; ?>;
            background-color:<?php echo isset($buildin_theme['buildin_popup']['wpb_nothanks_bg']) && !empty($buildin_theme['buildin_popup']['wpb_nothanks_bg']) ? esc_attr($buildin_theme['buildin_popup']['wpb_nothanks_bg']) : ''; ?>;
            color:<?php echo isset($buildin_theme['buildin_popup']['wpb_nothanks_text_font_color']) && !empty($buildin_theme['buildin_popup']['wpb_nothanks_text_font_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_nothanks_text_font_color']) : ''; ?>;
            -webkit-animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 0.5) : 1.5; ?>s; /* Safari 4.0 - 8.0 */
            animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 0.5) : 1.5; ?>s;
            animation-duration:1s; 
            -webkit-animation-duration: 1s; /* Safari 4.0 - 8.0 */
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25 .wpb_close_btn.wpb-close-option:after{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25 .wpb_close_btn.wpb-close-option{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme25-wrapper .wpb-fe-form-field.required.wpb-input-field-error{
            ...
            <div class="wpb-inner-wrapper" style="position:relative;"> 
                <div class="wpb-popup-content">
                    <form action="#" class="wpb-contact-form" name="wpb-custom-form-submission" id="inbuild-form">
                        <div class="wpb-theme25-wrapper">
                            <div class="wpb-theme25-inner-wrapper clearfix">
                                <div class="wpb-left-content">
                                    <div class="wpb-left-inner-content">
                                        ...
                                        <p class="wpb-left-content-desc animated fadeInDown"><?php echo isset($buildin_theme['buildin_popup']['wpb_subheader_text']) && !empty($buildin_theme['buildin_popup']['wpb_subheader_text']) ? esc_attr($buildin_theme['buildin_popup']['wpb_subheader_text']) : '' ?></p>
                                        <div class="wpb-theme25-form">
                                            <div class="wpb-left-input-field">
                                                <div class="wpb-left-input-wrap" id="wpb-right-input-name-label">
                                                    <?php if (isset($buildin_theme['buildin_popup']['wpb_name_label_text']) && !empty($buildin_theme['buildin_popup']['wpb_name_label_text'])) { ?>
                                                        <label class="animated fadeInUp">
                                                    ...
                                                    <?php } ?>
                                                    <input class="wpb-right-text-field wpb-fe-form-field wpb-name-field animated fadeInUp <?php
                                                ...
                                                <div class="wpb-left-input-wrap" id="wpb-right-input-email-label">
                                                    ...
                                                    <?php } ?>
                                                    <input class="wpb-email-field wpb-fe-form-field animated fadeInUp <?php
                                                ...
                                                <div class="wpb-left-input-wrap" id="wpb-right-input-message-label">
                                                ...
                                                <button class="wpb-subscribe-button wpb-subs-btn-1 wpb-submit-button animated fadeInUp" data-button-action="<?php echo!empty($buildin_theme['buildin_popup']["submit_click_event"]) ? $buildin_theme['buildin_popup']["submit_click_event"] : "";
                                                    ...
                                                    ?>" type="submit"><?php echo isset($buildin_theme['buildin_popup']['wpb_submit_text']) && !empty($buildin_theme['buildin_popup']['wpb_submit_text']) ? esc_attr($buildin_theme['buildin_popup']['wpb_submit_text']) : ''; ?></button>                                            
                                                <button class="wpb-subscribe-button wpb-subs-btn-2 animated fadeInUp" type="submit"><?php echo isset($buildin_theme['buildin_popup']['wpb_no_thanks_text']) && !empty($buildin_theme['buildin_popup']['wpb_no_thanks_text']) ? esc_attr($buildin_theme['buildin_popup']['wpb_no_thanks_text']) : ''; ?></button>                                            
                                            </div>                                                
                                        </div>
                                    </div>
                                </div>
                                <div class="wpb-right-content">
                                    <div class="wpb-right-side-map">
                                        <?php echo isset($buildin_theme['buildin_theme_google_embed']['wpb_builtin_google_map_embed']) && !empty($buildin_theme['buildin_theme_google_embed']['wpb_builtin_google_map_embed']) ? $buildin_theme['buildin_theme_google_embed']['wpb_builtin_google_map_embed'] : '<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2049.031647861907!2d-3.0764673841724584!3d59.09840418157868!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x489a553110a18735%3A0x86ba919f79f0900!2sWoodwick%2C+Orkney%2C+UK!5e0!3m2!1sen!2snp!4v1493896806186" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>'; ?>
                                    </div>                                
                                </div>
                            </div>
                        </div>
