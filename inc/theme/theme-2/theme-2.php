...
<div class="wpb-outer-wrap wpb-default-popup-layout wpb-<?php echo $wpb_buildin_theme_type; ?>" id="wpb-outer-wrap-<?php echo esc_attr($popup_id); ?>" data-popup-id="<?php echo esc_attr($popup_id); ?>" 
    ...
    <style type="text/css">
        ...
        <?php } ?>
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme2-wrapper .wpb-right-content{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme2-wrapper .wpb-left-content{
            background-image:url(<?php echo isset($buildin_theme['buildin_popup']['wpb_builtin_main_image']) && !empty($buildin_theme['buildin_popup']['wpb_builtin_main_image']) ? esc_url($buildin_theme['buildin_popup']['wpb_builtin_main_image']) : WPP_IMAGE_DIR . '/temp-2.png'; ?>);
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme2-wrapper .wpb-right-content-title{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme2-wrapper .wpb-right-desc{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme2-wrapper .wpb-right-highlight{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme2-wrapper input.wpb-right-text-field{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme2-wrapper .wpb-theme2-form input[type="text"]::-moz-placeholder,
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme2-wrapper .wpb-theme2-form input[type="text"]:-ms-input-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme2-wrapper .wpb-theme2-form input[type="text"]{
            font-family:<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) : ''; ?>;
            color:<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) . '!important' : ''; ?>;
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme2-wrapper .wpb-theme2-form input[type="text"]::-webkit-input-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme2-wrapper .wpb-theme2-form input[type="text"]{
            font-family:<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) : ''; ?>;
            color:<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) . '!important' : ''; ?> ;
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb_close_btn.wpb-close-option.wpb-theme-2-close-button{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme2-wrapper .wpb-subscribe-button{
            ...
            -webkit-animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 1.5) : 2.25; ?>s; /* Safari 4.0 - 8.0 */
            animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 1.25) : 2.25; ?>s;
            animation-duration:1.5s; 
            -webkit-animation-duration: 1.5s; /* Safari 4.0 - 8.0 */
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme2-wrapper .wpb-fe-form-field.required.wpb-input-field-error{
        ...
        <div class="wpb-main-inner-wrap animated <?php echo $wpb_popup_animation_option; ?>">
            ...
            <div class="wpb-inner-wrapper" style="position:relative;"> 
                <div class="wpb-popup-content">
                    ...
                    ?>">
                        <div class="wpb-theme2-wrapper">
                            <div class="wpb-left-content">
                            </div>
                            <div class="wpb-right-content">
                                <div class="wpb-right-inner-content">
                                    <p class="wpb-right-content-title animated fadeInRight"><?php echo isset($buildin_theme['buildin_popup']['wpb_header_text']) && !empty($buildin_theme['buildin_popup']['wpb_header_text']) ? esc_attr($buildin_theme['buildin_popup']['wpb_header_text']) : ''; ?><!--<span> Rest assured</span>--></p>
                                    <p class="wpb-right-desc animated fadeInRight"><?php echo isset($buildin_theme['buildin_popup']['wpb_subheader_text']) && !empty($buildin_theme['buildin_popup']['wpb_subheader_text']) ? esc_attr($buildin_theme['buildin_popup']['wpb_subheader_text']) : '' ?></p>
                                    <p class="wpb-right-highlight animated fadeInRight"><?php echo isset($buildin_theme['buildin_popup']['wpb_secondary_subheader_text']) && !empty($buildin_theme['buildin_popup']['wpb_secondary_subheader_text']) ? esc_attr($buildin_theme['buildin_popup']['wpb_secondary_subheader_text']) : ''; ?></p>
                                    <div class="wpb-theme2-form">
                                        <div class="wpb-right-input-field">
                                            <input type="text" class="wpb-right-text-field wpb-fe-form-field wpb-email-field required animated fadeInRight" name="wpb_email_address" placeholder="<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder']) : ''; ?>">
                                            <button class="wpb-theme2-button wpb-subscribe-button animated fadeInLeft <?php
