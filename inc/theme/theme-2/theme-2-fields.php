    ...
    <div class="wpb-default-setting-group-wrapper">
        ...
        <div class="wpb-default-setting-field-wrapper" id='wpb-basic-layout-setting'>
            ...
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                ...
                <div class="wpb-input-field">
                    <input class="buildin-default-font-color" id="wpb-upload-builtin-bg-image" type="text" name="buildin_theme[wpb_builtin_leftbg_color]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_builtin_leftbg_color']); ?>">
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
                ...
                <div class="wpb-input-field">
                    <input type="text" id="wpb-header-text" name="buildin_theme[wpb_header_text]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_header_text']); ?>" placeholder="<?php echo __('Better bedding Rest...', 'wp-popup-lite'); ?>">
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
            ...
            <div class="wpb-input-field-wrap" id="wpb-popup-position">
                ...
                <div class="wpb-input-field">
                    <input type="text" id="wpb-popup-sub-header-text" name="buildin_theme[wpb_subheader_text]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_subheader_text']); ?>" placeholder="<?php echo __('Subscribe to the huge mailing...', 'wp-popup-lite'); ?>">
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
            ...
            <div class="wpb-input-field-wrap" id="wpb-popup-background-field">
                ...
                <div class="wpb-input-field">
                    <input type="text" id="wpb-email-label-text" name="buildin_theme[wpb_secondary_subheader_text]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_secondary_subheader_text']); ?>" placeholder="<?php echo __('You will get free...', 'wp-popup-lite'); ?>">
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
                ...
                <div class="wpb-input-field-inner">
                    ...
                    <div class="wpb-input-field">
                        <input type="text" id="wpb-popup-header-font-size" name="buildin_theme[wpb_secondary_subheader_font_size]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_secondary_subheader_font_size']); ?>"><?php echo __('px', 'wp-popup-lite') ?>
                    </div>
                    <div class="wpb-input-field">
            ...
            <div class="wpb-input-field-wrap" id="wpb-hidden-overlay-color-field">
                ...
                <div class="wpb-input-field">
                    <input id="wpb-email-placeholder" type="text" name="buildin_theme[wpb_email_placeholder]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder']); ?>" placeholder="<?php echo __('email address', 'wp-popup-lite'); ?>"/>
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
            ...
            <div class="wpb-input-field-wrap" id="wpb-popup-shape">
                ...
                <div class="wpb-input-field">
                    <input type="text" id="wpb-submit-button-text" name="buildin_theme[wpb_submit_text]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_submit_text']); ?>" placeholder="<?php echo __('Join', 'wp-popup-lite'); ?>">
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
