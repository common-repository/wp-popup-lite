    ...
    <div class="wpb-default-setting-group-wrapper">
        ...
        <div class="wpb-default-setting-field-wrapper" id='wpb-basic-layout-setting'>
            ...
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                ...
                <div class="wpb-input-field">
                    <input id="wpb-upload-buildin-bg-image-Left" type="number" name="buildin_theme[wpb_builtin_main_image_left]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_builtin_main_image_left']); ?>"><?php echo __('px', 'wp-popup-lite') ?><p class="description"><?php echo __('Default: 40px','wp-popup-lite');?></p>
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
            ...
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                ...
                <div class="wpb-input-field-inner">
                    <div class="wpb-input-field">
                        <select name="buildin_theme[header_typography]" id="wpb-header-font-family">
            ...
            <div class="wpb-input-field-wrap" id="wpb-popup-position">
                ...
                <div class="wpb-input-field">
                    <input type="text" id="wpb-popup-sub-header-text" name="buildin_theme[wpb_subheader_text]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_subheader_text']); ?>" placeholder="<?php echo __('Subscribe to huge mailing...', 'wp-popup-lite'); ?>">
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
            ...
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                ...
                <div class="wpb-input-field">
                    <input type="text" class="buildin-default-font-color"  id="wpb-popup-submit-button-bg" name="buildin_theme[wpb_submit_button_bg_color]" value="<?php echo isset($buildin_theme['buildin_popup']['wpb_submit_button_text_font_color']) && !empty($buildin_theme['buildin_popup']['wpb_submit_button_text_font_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_submit_button_text_font_color']) : ''; ?>" >
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
            ...
            <div class="wpb-input-field-wrap" id="wpb-popup-shape">
                ...
                <div class="wpb-input-field">
                    <input type="text" id="wpb-oncetext-button-text" name="buildin_theme[wpb_popup_once_text]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_popup_once_text']); ?>" placeholder="<?php echo __('Don\'t show this...', 'wp-popup-lite'); ?>">
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
                ...
                <div class="wpb-input-field-inner">
                    ...
                    <!--<div class="wpb-input-field">
                        <input type="text" id="wpb-popup-oncetext-font-size" name="buildin_theme[wpb_popup_once_text_size]" value="< ?php echo esc_attr($buildin_theme['buildin_popup']['wpb_popup_once_text_size']); ?>" >< ?php echo __('px', 'wp-popup-lite') ?>
                    </div>-->
                    <div class="wpb-input-field">
                        <input type="text" class="buildin-default-font-color" id="wpb-popup-security-text-font-color" name="buildin_theme[wpb_popup_once_text_color]" value="<?php echo isset($buildin_theme['buildin_popup']['wpb_popup_once_text_color']) && !empty($buildin_theme['buildin_popup']['wpb_popup_once_text_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_popup_once_text_color']) : ''; ?>">
                    </div>
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                ...
                <div class="wpb-input-field">
                    <input type="text" class="buildin-default-font-color" id="wpb-popup-security-text-font-color" name="buildin_theme[wpb_popup_border_color]" value="<?php echo isset($buildin_theme['buildin_popup']['wpb_popup_border_color']) && !empty($buildin_theme['buildin_popup']['wpb_popup_border_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_popup_border_color']) : ''; ?>">
                </div>
            </div>
        </div>
    </div>
