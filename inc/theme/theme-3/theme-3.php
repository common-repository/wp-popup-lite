...
if (isset($buildin_theme['buildin_popup']['wpb_popup_once_text_typography']) && $buildin_theme['buildin_popup']['wpb_popup_once_text_typography'] != 'default') {
    $fonts_final = str_replace(' ', '+', $buildin_theme['buildin_popup']['wpb_popup_once_text_typography']);
    echo "<link rel='stylesheet' id='wpb-google-fonts-style-css' href='//fonts.googleapis.com/css?family=" . $fonts_final . "'; type='text/css' media='all' />";
}
...
<div class="wpb-outer-wrap wpb-default-popup-layout wpb-<?php echo $wpb_buildin_theme_type; ?>" id="wpb-outer-wrap-<?php echo esc_attr($popup_id); ?>" data-popup-id="<?php echo esc_attr($popup_id); ?>" 
     data-popup-title="<?php echo $title; ?>" data-load-delay="<?php
     if (isset($page_wise_popup_delay_time) && !empty($page_wise_popup_delay_time)) {
         echo $page_wise_popup_delay_time;
     } else if (isset($wpb_default_settings['popup_delay']) && !empty($wpb_default_settings['popup_delay'])) {
         esc_attr($wpb_default_settings['popup_delay']);
     }
     ?>" 
     data-scroll-offset="<?php
     if (isset($wpb_spopup_scroll_offset) && !empty($wpb_spopup_scroll_offset)) {
         echo esc_attr($wpb_spopup_scroll_offset);
     } else if (isset($wpb_default_settings['wpb_scroll_offset']) && !empty($wpb_default_settings['wpb_scroll_offset'])) {
         echo esc_attr($wpb_default_settings['wpb_scroll_offset']);
     }
     ?>"
     data-idle-wait-period="<?php
     if (isset($wpb_ipopup_wait_period) && !empty($wpb_ipopup_wait_period) && $wpb_ipopup_wait_period != 'default') {
         echo esc_attr($wpb_ipopup_wait_period);
     } else if (isset($wpb_default_settings['wpb_ideal_wait_period']) && !empty($wpb_default_settings['wpb_ideal_wait_period'])) {
         echo esc_attr($wpb_default_settings['wpb_ideal_wait_period']);
     }
     ?>" 
    ...
    <style type="text/css">
        ...
        <?php } ?>
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme3-wrapper{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme3-wrapper .wpb-left-content-title{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme3-wrapper .wpb-left-desc{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme3-wrapper input.wpb-left-text-field{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme3-wrapper .wpb-theme3-form input[type="text"]::-moz-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme3-wrapper .wpb-theme3-form input[type="text"]{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme3-wrapper .wpb-theme3-form input[type="text"]:-ms-input-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme3-wrapper .wpb-theme3-form input[type="text"]{
            font-family:<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) : ''; ?>;
            color:<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) . '!important' : ''; ?>;
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme3-wrapper .wpb-theme3-form input[type="text"]::-webkit-input-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme3-wrapper .wpb-theme3-form input[type="text"]{
            font-family:<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) : ''; ?>;
            color:<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) . '!important' : ''; ?> ;
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb_close_btn.wpb-close-option.wpb-theme-3-close-button{
            background-color:<?php echo isset($buildin_theme['buildin_popup']['wpb_close_icon_bg_color']) && !empty($buildin_theme['buildin_popup']['wpb_close_icon_bg_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_close_icon_bg_color']) : ''; ?>;
            color:<?php echo isset($buildin_theme['buildin_popup']['wpb_close_icon_color']) && !empty($buildin_theme['buildin_popup']['wpb_close_icon_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_close_icon_color']) : ''; ?>
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme3-inner-wrapper:before{
            border-top:<?php echo isset($buildin_theme['buildin_popup']['wpb_popup_border_color']) && !empty($buildin_theme['buildin_popup']['wpb_popup_border_color']) ? '1px solid ' . esc_attr($buildin_theme['buildin_popup']['wpb_popup_border_color']) : ''; ?>;
            border-bottom:<?php echo isset($buildin_theme['buildin_popup']['wpb_popup_border_color']) && !empty($buildin_theme['buildin_popup']['wpb_popup_border_color']) ? '1px solid ' . esc_attr($buildin_theme['buildin_popup']['wpb_popup_border_color']) : ''; ?>;
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme3-inner-wrapper:after{
            border-left:<?php echo isset($buildin_theme['buildin_popup']['wpb_popup_border_color']) && !empty($buildin_theme['buildin_popup']['wpb_popup_border_color']) ? '1px solid ' . esc_attr($buildin_theme['buildin_popup']['wpb_popup_border_color']) : ''; ?>;
            border-right:<?php echo isset($buildin_theme['buildin_popup']['wpb_popup_border_color']) && !empty($buildin_theme['buildin_popup']['wpb_popup_border_color']) ? '1px solid ' . esc_attr($buildin_theme['buildin_popup']['wpb_popup_border_color']) : ''; ?>; 
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme3-wrapper .wpb-subscribe-button{
            ...
            -webkit-animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 1) : 3; ?>s; /* Safari 4.0 - 8.0 */
            animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 1) : 3; ?>s;
            animation-duration:1.5s; 
            -webkit-animation-duration: 1.5s; /* Safari 4.0 - 8.0 */
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme3-wrapper .wpb-right-content{
            ...
            -webkit-animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 1.5) : 3.5; ?>s; /* Safari 4.0 - 8.0 */
            animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 1.5) : 3.5; ?>s; 
            animation-duration:1.5s; 
            -webkit-animation-duration: 1.5s; /* Safari 4.0 - 8.0 */
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme-checkbox{
            ...
            -webkit-animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 1.75) : 3.75; ?>s; /* Safari 4.0 - 8.0 */
            animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 1.75) : 3.75; ?>s; 
            animation-duration:1.5s; 
            -webkit-animation-duration: 1.5s; /* Safari 4.0 - 8.0 */
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb_close_btn.wpb-close-option.wpb-theme-3-close-button{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme3-wrapper .wpb-fe-form-field.required.wpb-input-field-error{
        ...
        <div class="wpb-main-inner-wrap animated <?php echo $wpb_popup_animation_option; ?>">
            ...
            <div class="wpb-inner-wrapper" style="position:relative;"> 
                <div class="wpb-popup-content">
                    ...
                    ?>">
                        <div class="wpb-theme3-wrapper">
                            <div class="wpb-theme3-inner-wrapper">
                                <div class="wpb-left-content">
                                    <div class="wpb-left-inner-content">
                                        <p class="wpb-left-content-title animated fadeInLeft"><?php echo isset($buildin_theme['buildin_popup']['wpb_header_text']) && !empty($buildin_theme['buildin_popup']['wpb_header_text']) ? esc_attr($buildin_theme['buildin_popup']['wpb_header_text']) : ''; ?></p>
                                        <p class="wpb-left-desc animated fadeInLeft"><?php echo isset($buildin_theme['buildin_popup']['wpb_subheader_text']) && !empty($buildin_theme['buildin_popup']['wpb_subheader_text']) ? esc_attr($buildin_theme['buildin_popup']['wpb_subheader_text']) : '' ?></p>
                                        <div class="wpb-theme3-form">
                                            <div class="wpb-left-input-field">
                                                <input class="wpb-left-text-field wpb-fe-form-field wpb-email-field required animated fadeInRight" type="text" name="wpb_email_address" placeholder="<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder']) : ''; ?>">
                                                <button class="wpb-theme3-button wpb-subscribe-button animated fadeInUp <?php
                                                ...
                                                ?>"><?php echo isset($buildin_theme['buildin_popup']['wpb_submit_text']) && !empty($buildin_theme['buildin_popup']['wpb_submit_text']) ? esc_attr($buildin_theme['buildin_popup']['wpb_submit_text']) : ''; ?></button>
                                                    ...
                                                    <div class="wpb-theme-checkbox animated fadeInUp">
                                ...
                                <div class="wpb-right-content animated bounceInRight">
                                    <?php if (isset($buildin_theme['buildin_popup']['wpb_builtin_main_image']) && !empty($buildin_theme['buildin_popup']['wpb_builtin_main_image'])) { ?>
                                        <img src="<?php echo isset($buildin_theme['buildin_popup']['wpb_builtin_main_image']) && !empty($buildin_theme['buildin_popup']['wpb_builtin_main_image']) ? esc_url($buildin_theme['buildin_popup']['wpb_builtin_main_image']) : WPP_IMAGE_DIR . '/temp-3.png'; ?>">
                                    <?php } ?>
                                </div>           
                            </div>
                        </div>
