...
<div class="wpb-outer-wrap wpb-default-popup-layout wpb-<?php echo $wpb_buildin_theme_type; ?>" id="wpb-outer-wrap-<?php echo esc_attr($popup_id); ?>" data-popup-id="<?php echo esc_attr($popup_id); ?>" 
    ...
    <style type="text/css">
        ...
        <?php } ?>
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme31-wrapper{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?>  .wpb-theme31-wrapper .wpb-left-side{
            background-color:<?php echo isset($buildin_theme['buildin_popup']['wpb_builtin_rightbg_color']) && !empty($buildin_theme['buildin_popup']['wpb_builtin_leftbg_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_builtin_leftbg_color']) : ''; ?>;
            background-image:url(<?php echo isset($buildin_theme['buildin_popup']['wpb_builtin_rightbg_image']) && !empty($buildin_theme['buildin_popup']['wpb_builtin_leftbg_image']) ? esc_attr($buildin_theme['buildin_popup']['wpb_builtin_leftbg_image']) : ''; ?>);  
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme31-wrapper .wpb-right-content-title{
            ...
            -webkit-animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 0.1) : 1.1; ?>s; /* Safari 4.0 - 8.0 */
            animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 0.1) : 1.1; ?>s;
            animation-duration:1s; 
            -webkit-animation-duration: 1s; /* Safari 4.0 - 8.0 */
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme31-wrapper .wpb-right-content-desc{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme31-wrapper .wpb-left-image-content{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme31-wrapper .wpb-buy-button
        {
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme31 .wpb_close_btn.wpb-close-option:after{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme-31 .wpb_close_btn.wpb-close-option{
        ...
        <div class="wpb-main-inner-wrap animated <?php echo $wpb_popup_animation_option; ?>">
            ...
            <div class="wpb-inner-wrapper" style="position:relative;"> 
                <div class="wpb-popup-content">
                    ...
                    ?>">
                        <div class="wpb-theme31-wrapper">
                            <div class="wpb-theme31-inner-wrapper clearfix">
                                <div class="wpb-left-content">
                                    <div class="wpb-left-side animated fadeInRight">
                                    </div>
                                    <div class="wpb-left-image-content animated fadeInLeft">
                                        <?php if (isset($buildin_theme['buildin_popup']['wpb_builtin_main_image']) && !empty($buildin_theme['buildin_popup']['wpb_builtin_main_image'])) { ?>
                                            <img src="<?php echo isset($buildin_theme['buildin_popup']['wpb_builtin_main_image']) && !empty($buildin_theme['buildin_popup']['wpb_builtin_main_image']) ? esc_url($buildin_theme['buildin_popup']['wpb_builtin_main_image']) : WPP_IMAGE_DIR . '/shop-man.png'; ?>">
                                        <?php } ?>
                                    </div>
                                </div>
                                <div class="wpb-right-content">
                                    <div class="wpb-right-inner-content">                                    
                                        ...
                                        <p class="wpb-right-content-desc animated fadeInRight"><?php echo isset($buildin_theme['buildin_popup']['wpb_subheader_text']) && !empty($buildin_theme['buildin_popup']['wpb_subheader_text']) ? esc_attr($buildin_theme['buildin_popup']['wpb_subheader_text']) : '' ?></p>
                                        <a href="<?php echo isset($buildin_theme['buildin_popup']['wpb_submit_button_link']) && !empty($buildin_theme['buildin_popup']['wpb_submit_button_link']) ? esc_url($buildin_theme['buildin_popup']['wpb_submit_button_link']) : ''; ?>" class="wpb-buy-button animated fadeInUp"><?php echo isset($buildin_theme['buildin_popup']['wpb_submit_text']) && !empty($buildin_theme['buildin_popup']['wpb_submit_text']) ? esc_attr($buildin_theme['buildin_popup']['wpb_submit_text']) : ''; ?></a>                                        
                                    </div>
                                </div>
                            </div>
                        </div>
