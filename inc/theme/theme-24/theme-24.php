...
<div class="wpb-outer-wrap wpb-default-popup-layout wpb-<?php echo $wpb_buildin_theme_type; ?>" id="wpb-outer-wrap-<?php echo esc_attr($popup_id); ?>" data-popup-id="<?php echo esc_attr($popup_id); ?>" 
    ...
    <style type="text/css">
        ...
        <?php } ?>
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper .wpb-right-content{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper .wpb-right-content-title{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper .wpb-right-content-desc{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper #wpb-right-input-name-label{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper #wpb-right-input-email-label{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper #wpb-right-input-message-label{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper input.wpb-name-field{
            -webkit-animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 0.5) : 1.5; ?>s; /* Safari 4.0 - 8.0 */
            animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 0.5) : 1.5; ?>s;
            animation-duration:1s; 
            -webkit-animation-duration: 1s; /* Safari 4.0 - 8.0 */
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper input.wpb-email-field{
            -webkit-animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 0.5) : 1.5; ?>s; /* Safari 4.0 - 8.0 */
            animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 0.5) : 1.5; ?>s;
            animation-duration:1s; 
            -webkit-animation-duration: 1s; /* Safari 4.0 - 8.0 */
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper textarea.wpb-message-field{
            -webkit-animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 0.5) : 1.5; ?>s; /* Safari 4.0 - 8.0 */
            animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 0.5) : 1.5; ?>s;
            animation-duration:1s; 
            -webkit-animation-duration: 1s; /* Safari 4.0 - 8.0 */
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper .wpb-left-content .wpb-left-image-content{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper .wpb-theme24-form input[type="text"].wpb-name-field::-moz-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper .wpb-theme24-form input[type="text"].wpb-name-field{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper .wpb-theme24-form input[type="text"].wpb-name-field:-ms-input-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper .wpb-theme24-form input[type="text"].wpb-name-field{
            font-family:<?php echo isset($buildin_theme['buildin_popup']['wpb_name_placeholder_typography']) && !empty($buildin_theme['buildin_popup']['wpb_name_placeholder_typography']) ? esc_attr($buildin_theme['buildin_popup']['wpb_name_placeholder_typography']) : ''; ?>;
            color:<?php echo isset($buildin_theme['buildin_popup']['wpb_name_placeholder_font_color']) && !empty($buildin_theme['buildin_popup']['wpb_name_placeholder_font_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_name_placeholder_font_color']) . '!important' : ''; ?>;
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper .wpb-theme24-form input[type="text"].wpb-name-field::-webkit-input-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper .wpb-theme24-form input[type="text"].wpb-name-field{
            font-family:<?php echo isset($buildin_theme['buildin_popup']['wpb_name_placeholder_typography']) && !empty($buildin_theme['buildin_popup']['wpb_name_placeholder_typography']) ? esc_attr($buildin_theme['buildin_popup']['wpb_name_placeholder_typography']) : ''; ?>;
            color:<?php echo isset($buildin_theme['buildin_popup']['wpb_name_placeholder_font_color']) && !empty($buildin_theme['buildin_popup']['wpb_name_placeholder_font_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_name_placeholder_font_color']) . '!important' : ''; ?>;
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper .wpb-theme24-form input[type="text"].wpb-email-field::-moz-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper .wpb-theme24-form input[type="text"].wpb-email-field{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper .wpb-theme24-form input[type="text"].wpb-email-field:-ms-input-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper .wpb-theme24-form input[type="text"].wpb-email-field{
            font-family:<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) : ''; ?>;
            color:<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) . '!important' : ''; ?>;
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper .wpb-theme24-form input[type="text"].wpb-email-field::-webkit-input-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper .wpb-theme24-form input[type="text"].wpb-email-field{
            font-family:<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) : ''; ?>;
            color:<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) . '!important' : ''; ?>;
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper .wpb-theme24-form textarea.wpb-message-field::-webkit-input-placeholder,  
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper .wpb-theme24-form textarea.wpb-message-field{
            font-family:<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) : ''; ?>;
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper .wpb-theme24-form textarea.wpb-message-field::-moz-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper .wpb-theme24-form textarea.wpb-message-field{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper .wpb-theme24-form textarea.wpb-message-field:-ms-input-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper .wpb-theme24-form textarea.wpb-message-field{ 
            font-family:<?php echo isset($buildin_theme['buildin_popup']['wpb_message_placeholder_typography']) && !empty($buildin_theme['buildin_popup']['wpb_message_placeholder_typography']) ? esc_attr($buildin_theme['buildin_popup']['wpb_message_placeholder_typography']) : ''; ?>;
            color:<?php echo isset($buildin_theme['buildin_popup']['wpb_message_placeholder_font_color']) && !empty($buildin_theme['buildin_popup']['wpb_message_placeholder_font_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_message_placeholder_font_color']) . '!important' : ''; ?> ;   
        } 
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper .wpb-theme24-form textarea.wpb-message-field:-o-input-placeholder, 
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper .wpb-theme24-form textarea.wpb-message-field{ 
            font-family:<?php echo isset($buildin_theme['buildin_popup']['wpb_message_placeholder_typography']) && !empty($buildin_theme['buildin_popup']['wpb_message_placeholder_typography']) ? esc_attr($buildin_theme['buildin_popup']['wpb_message_placeholder_typography']) : ''; ?>;
            color:<?php echo isset($buildin_theme['buildin_popup']['wpb_message_placeholder_font_color']) && !empty($buildin_theme['buildin_popup']['wpb_message_placeholder_font_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_message_placeholder_font_color']) . '!important' : ''; ?> ;   
        }  
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper .wpb-subscribe-button{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24 .wpb_close_btn.wpb-close-option:after{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24 .wpb_close_btn.wpb-close-option{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper .wpb-fe-form-field.required.wpb-input-field-error{
            border-color:red !important;
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme24-wrapper .wpb-subscribe-button i{
            ...
            <div class="wpb-inner-wrapper" style="position:relative;"> 
                <div class="wpb-popup-content">
                    <form action="#" class="wpb-contact-form" name="wpb-custom-form-submission" id="inbuild-form">
                        <div class="wpb-theme24-wrapper">
                            <div class="wpb-theme24-inner-wrapper clearfix">
                                <?php if (isset($buildin_theme['buildin_popup']['wpb_builtin_main_image']) && !empty($buildin_theme['buildin_popup']['wpb_builtin_main_image'])) { ?>
                                    <div class="wpb-left-content">
                                        ...
                                        <div class="wpb-left-image-content animated fadeInLeft">
                                            <img src="<?php echo isset($buildin_theme['buildin_popup']['wpb_builtin_main_image']) && !empty($buildin_theme['buildin_popup']['wpb_builtin_main_image']) ? esc_url($buildin_theme['buildin_popup']['wpb_builtin_main_image']) : WPP_IMAGE_DIR . '/woman-1.png'; ?>">
                                        </div>
                                    </div>
                                <?php } ?>
                                    ...
                                    <div class="wpb-right-inner-content">
                                        ...
                                        <div class="wpb-theme24-form">
                                            <div class="wpb-right-input-field">
                                                ...
                                                <button class="wpb-subscribe-button wpb-submit-button animated bounceInUp" data-button-action="<?php echo!empty($buildin_theme['buildin_popup']["submit_click_event"]) ? $buildin_theme['buildin_popup']["submit_click_event"] : "";
