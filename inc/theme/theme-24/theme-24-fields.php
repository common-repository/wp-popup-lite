    ...
    <div class="wpb-default-setting-group-wrapper">
        ...
        <div class="wpb-default-setting-field-wrapper" id='wpb-basic-layout-setting'>
            ...
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                ...
                <div class="wpb-input-field">
                    <input id="wpb-upload-buildin-bg-image-top" type="number" name="buildin_theme[wpb_builtin_main_image_top]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_builtin_main_image_top']); ?>"><?php echo __('px', 'wp-popup-lite') ?><p class="description"><?php echo __('Default: 167px','wp-popup-lite');?></p>
                </div>
            ...
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                ...
                <div class="wpb-input-field">
                    <input id="wpb-upload-buildin-bg-image-Left" type="number" name="buildin_theme[wpb_builtin_main_image_left]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_builtin_main_image_left']); ?>"><?php echo __('px', 'wp-popup-lite') ?><p class="description"><?php echo __('Default: -8px','wp-popup-lite');?></p>
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
