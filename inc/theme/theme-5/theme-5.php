...
<div class="wpb-outer-wrap wpb-default-popup-layout wpb-<?php echo $wpb_buildin_theme_type; ?>" id="wpb-outer-wrap-<?php echo esc_attr($popup_id); ?>" data-popup-id="<?php echo esc_attr($popup_id); ?>" 
    ...
    <style type="text/css">
        ...
        <?php } ?>
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-right-content{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-left-side{
            background-color:<?php echo isset($buildin_theme['buildin_popup']['wpb_builtin_leftbg_color']) && !empty($buildin_theme['buildin_popup']['wpb_builtin_leftbg_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_builtin_leftbg_color']) : ''; ?>;
            <?php echo isset($buildin_theme['buildin_popup']['wpb_builtin_leftbg_image']) && !empty($buildin_theme['buildin_popup']['wpb_builtin_leftbg_image']) ? 'background-image:url(' . esc_attr($buildin_theme['buildin_popup']['wpb_builtin_leftbg_image']) . ');' : ''; ?>   
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme5-wrapper .wpb-right-content-title{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme5-wrapper .wpb-right-content-sub-title{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme5-wrapper input.wpb-right-text-field{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme5-wrapper .wpb-theme5-form input[type="text"]::-moz-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme5-wrapper .wpb-theme5-form input[type="text"]{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme5-wrapper .wpb-theme5-form input[type="text"]:-ms-input-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme5-wrapper .wpb-theme5-form input[type="text"]{
            font-family:<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) : ''; ?>;
            color:<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) . '!important' : ''; ?>;
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme5-wrapper .wpb-theme5-form input[type="text"]::-webkit-input-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme5-wrapper .wpb-theme5-form input[type="text"]{
            font-family:<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) : ''; ?>;
            color:<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) . '!important' : ''; ?> ;
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme5-wrapper .wpb-subscribe-button{
            ...
            -webkit-animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 1) : 2; ?>s; /* Safari 4.0 - 8.0 */
            animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 1) : 2; ?>s;
            animation-duration:1.5s; 
            -webkit-animation-duration: 1.5s; /* Safari 4.0 - 8.0 */
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme5-wrapper .wpb-theme5-button{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme-5 .wpb-subscribe-button:after{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme-5 .wpb-theme-info{
            ...
            font-size:<?php echo isset($buildin_theme['buildin_popup']['wpb_security_text_font_size']) && !empty($buildin_theme['buildin_popup']['wpb_security_text_font_size']) ? esc_attr($buildin_theme['buildin_popup']['wpb_security_text_font_size']) . 'px' : ''; ?>;
            ...
            -webkit-animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 2) : 3; ?>s; /* Safari 4.0 - 8.0 */
            animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 2) : 3; ?>s;
            animation-duration:1.5s; 
            -webkit-animation-duration: 1.5s; /* Safari 4.0 - 8.0 */
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme-5 .wpb-left-image-content{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb_close_btn.wpb-close-option.wpb-theme-5-close-button{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme5-wrapper .wpb-fe-form-field.required.wpb-input-field-error{
        ...
        <div class="wpb-main-inner-wrap animated <?php echo $wpb_popup_animation_option; ?>">
            ...
            <div class="wpb-inner-wrapper" style="position:relative;"> 
                <div class="wpb-popup-content">
                    ...
                    ?>">
                        <div class="wpb-theme5-wrapper">
                            <div class="wpb-theme5-inner-wrapper clearfix">
                                <div class="wpb-left-content">
                                    <div class="wpb-left-side">
                                    </div>
                                    <div class="wpb-left-image-content animated fadeIn">
                                        <?php if (isset($buildin_theme['buildin_popup']['wpb_builtin_main_image']) && !empty($buildin_theme['buildin_popup']['wpb_builtin_main_image'])) { ?>
                                            <img src="<?php echo isset($buildin_theme['buildin_popup']['wpb_builtin_main_image']) && !empty($buildin_theme['buildin_popup']['wpb_builtin_main_image']) ? esc_url($buildin_theme['buildin_popup']['wpb_builtin_main_image']) : WPP_IMAGE_DIR . '/temp-5.png'; ?>">
                                        <?php } ?>
                                    </div>
                                </div>
                                <div class="wpb-right-content clearfix">
                                    <div class="wpb-right-inner-content">
                                        <p class="wpb-right-content-title animated fadeInLeft"><?php echo isset($buildin_theme['buildin_popup']['wpb_header_text']) && !empty($buildin_theme['buildin_popup']['wpb_header_text']) ? esc_attr($buildin_theme['buildin_popup']['wpb_header_text']) : ''; ?></p>
                                        <span class="wpb-right-content-sub-title animated fadeInRight"><?php echo isset($buildin_theme['buildin_popup']['wpb_subheader_text']) && !empty($buildin_theme['buildin_popup']['wpb_subheader_text']) ? esc_attr($buildin_theme['buildin_popup']['wpb_subheader_text']) : '' ?></span>
                                        <div class="wpb-theme5-form">
                                            <div class="wpb-right-input-field">
                                                <input class="wpb-right-text-field wpb-fe-form-field wpb-email-field required animated fadeInDown" type="text" name="wpb_email_address" placeholder="<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder']) : ''; ?>">
                                                <button type="submit" class="wpb-subscribe-button wpb-subscribe-button animated fadeInUp <?php
                                            ...
                                            <button class="wpb-theme5-button wpb_close_btn animated fadeInDown" type="button"><?php echo isset($buildin_theme['buildin_popup']['wpb_no_thanks_text']) && !empty($buildin_theme['buildin_popup']['wpb_no_thanks_text']) ? esc_attr($buildin_theme['buildin_popup']['wpb_no_thanks_text']) : ''; ?></button> 
                                        </div>
                                        <?php if (isset($buildin_theme['buildin_popup']['wpb_security_text']) && !empty($buildin_theme['buildin_popup']['wpb_security_text'])) { ?>
                                            <p class="wpb-theme-info animated fadeInUp"><?php echo isset($buildin_theme['buildin_popup']['wpb_security_text']) && !empty($buildin_theme['buildin_popup']['wpb_security_text']) ? esc_attr($buildin_theme['buildin_popup']['wpb_security_text']) : ''; ?></p>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
