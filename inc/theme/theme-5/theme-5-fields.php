    ...
    <div class="wpb-default-setting-group-wrapper">
        ...
        <div class="wpb-default-setting-field-wrapper" id='wpb-basic-layout-setting'>
            ...
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                ...
                <div class="wpb-input-field">
                    <input class="buildin-default-font-color" id="wpb-upload-builtin-bg-image" type="text" name="buildin_theme[wpb_builtin_rightbg_color]" value="<?php echo isset($buildin_theme['buildin_popup']['wpb_builtin_rightbg_color']) && !empty($buildin_theme['buildin_popup']['wpb_builtin_rightbg_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_builtin_rightbg_color']) : ''; ?>">
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
            ...
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                ...
                <div class="wpb-input-field">
                    <input id="wpb-upload-buildin-bg-image-top" type="number" name="buildin_theme[wpb_builtin_main_image_top]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_builtin_main_image_top']); ?>"><?php echo __('px', 'wp-popup-lite') ?><p class="description"><?php echo __('Default: 10px','wp-popup-lite');?></p>
                </div>
            ...
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                ...
                <div class="wpb-input-field">
                    <input id="wpb-upload-buildin-bg-image-Left" type="number" name="buildin_theme[wpb_builtin_main_image_left]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_builtin_main_image_left']); ?>"><?php echo __('px', 'wp-popup-lite') ?><p class="description"><?php echo __('Default: 0px','wp-popup-lite');?></p>
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
                ...
                <div class="wpb-input-field">
                    <input type="text" id="wpb-header-text" name="buildin_theme[wpb_header_text]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_header_text']); ?>" placeholder="<?php echo __('Become the fan...', 'wp-popup-lite'); ?>">
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
            ...
            <div class="wpb-input-field-wrap" id="wpb-popup-position">
                ...
                <div class="wpb-input-field">
                    <input type="text" id="wpb-popup-sub-header-text" name="buildin_theme[wpb_subheader_text]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_subheader_text']); ?>" placeholder="<?php echo __('Join our mailing...', 'wp-popup-lite'); ?>">
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
            ...
            <div class="wpb-input-field-wrap" id="wpb-hidden-overlay-color-field">
                ...
                <div class="wpb-input-field">
                    <input id="wpb-upload-mpopup-bg-image" type="text" name="buildin_theme[wpb_email_placeholder]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder']); ?>" placeholder="<?php echo __('JOHNDOE@YOURDOMAIN...', 'wp-popup-lite'); ?>"/>
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
            ...
            <div class="wpb-input-field-wrap" id="wpb-popup-shape">
                <div class="wpb-input-field-title">
                    <label>
                        <h4><?php echo __('Not Now Text', 'wp-popup-lite') ?></h4>
                    </label>
                </div>
                <div class="wpb-input-field">
                    <input type="text" id="wpb-submit-button-text" name="buildin_theme[wpb_no_thanks_text]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_no_thanks_text']); ?>" placeholder="<?php echo __('NOT NOW!', 'wp-popup-lite'); ?>">
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
                    <label>
                        <h4><?php echo __('Not Now Text Typography', 'wp-popup-lite') ?></h4>
                    </label>
                </div>
                <div class="wpb-input-field-inner">
                    <div class="wpb-input-field">
                        <select name="buildin_theme[wpb_nothanks_text_typography]" id="wpb-inner-email-label-font-family">
                            <option value="default"><?php _e('Default', 'wp-popup-lite'); ?></option>
                            <?php foreach (get_option('wpb_typo_fonts') as $wpb_font) { ?>
                                <option value="<?php echo $wpb_font; ?>" <?php
                    ...
                    <!--<div class="wpb-input-field">
                        <input type="text" id="wpb-popup-header-font-size" name="buildin_theme[wpb_nothanks_text_font_size]" value="< ?php echo esc_attr($buildin_theme['buildin_popup']['wpb_nothanks_text_font_size']); ?>">< ?php echo __('px', 'wp-popup-lite') ?>
                    </div>-->
                    <div class="wpb-input-field">
                        <input type="text" class="buildin-default-font-color" id="wpb-popup-email-label-font-color" name="buildin_theme[wpb_nothanks_text_font_color]" value="<?php echo isset($buildin_theme['buildin_popup']['wpb_nothanks_text_font_color']) && !empty($buildin_theme['buildin_popup']['wpb_nothanks_text_font_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_nothanks_text_font_color']) : ''; ?>">
                    </div>
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
            ...
            <div class="wpb-input-field-wrap" id="wpb-popup-shape">
                ...
                <div class="wpb-input-field">
                    <input type="text" id="wpb-submit-button-text" name="buildin_theme[wpb_security_text]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_security_text']); ?>" placeholder = "<?php _e('Your information will...','wp-popup-lite');?>">
                </div>
            ...
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                ...
                <div class="wpb-input-field-inner">
                    ...
                    <!--<div class="wpb-input-field">
                        <input type="text" id="wpb-popup-header-font-size" name="buildin_theme[wpb_security_text_font_size]" value="< ?php echo esc_attr($buildin_theme['buildin_popup']['wpb_security_text_font_size']); ?>" >< ?php echo __('px', 'wp-popup-lite') ?>
                    </div>-->
                    <div class="wpb-input-field">
