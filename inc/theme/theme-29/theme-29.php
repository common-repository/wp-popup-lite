...
if (isset($buildin_theme['buildin_popup']['wpb_old_price_typography']) && $buildin_theme['buildin_popup']['wpb_old_price_typography'] != 'default') {
    $fonts_final = str_replace(' ', '+', $buildin_theme['buildin_popup']['wpb_old_price_typography']);
    echo "<link rel='stylesheet' id='wpb-google-fonts-style-css' href='//fonts.googleapis.com/css?family=" . $fonts_final . "' type='text/css' media='all' />";
}
...
<div class="wpb-outer-wrap wpb-default-popup-layout wpb-<?php echo $wpb_buildin_theme_type; ?>" id="wpb-outer-wrap-<?php echo esc_attr($popup_id); ?>" data-popup-id="<?php echo esc_attr($popup_id); ?>" 
    ...
    <style type="text/css">
        ...
        <?php } ?>
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme29-wrapper .wpb-theme29-inner-wrapper{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme29-wrapper .wpb-left-content-title{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme29-wrapper .cart-price-wrap{
            -webkit-animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 0.2) : 1.2; ?>s; /* Safari 4.0 - 8.0 */
            animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 0.2) : 1.2; ?>s;
            animation-duration:1s; 
            -webkit-animation-duration: 1s; /* Safari 4.0 - 8.0 */  
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme29-wrapper .wpb-left-content-desc{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme29-wrapper .cart-price-wrap del{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme29-wrapper .wpb-right-image-content{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme29-wrapper .wpb-subscribe-button{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme29 .wpb_close_btn.wpb-close-option:after{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme-29 .wpb_close_btn.wpb-close-option{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme29-wrapper .wpb-buy-button{
            background-color:<?php echo isset($buildin_theme['buildin_popup']['wpb_submit_button_bg_color']) && !empty($buildin_theme['buildin_popup']['wpb_submit_button_bg_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_submit_button_bg_color']) : ''; ?>;     
            color:<?php echo isset($buildin_theme['buildin_popup']['wpb_submit_button_text_font_color']) && !empty($buildin_theme['buildin_popup']['wpb_submit_button_text_font_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_submit_button_text_font_color']) : ''; ?>;
            font-family:<?php echo isset($buildin_theme['buildin_popup']['wpb_submit_button_text_typography']) && !empty($buildin_theme['buildin_popup']['wpb_submit_button_text_typography']) ? esc_attr($buildin_theme['buildin_popup']['wpb_submit_button_text_typography']) : ''; ?>;
        ...
        <div class="wpb-main-inner-wrap animated <?php echo $wpb_popup_animation_option; ?>">
            ...
            <div class="wpb-inner-wrapper" style="position:relative;"> 
                <div class="wpb-popup-content">
                    ...
                    ?>">
                        <div class="wpb-theme29-wrapper">
                            <div class="wpb-theme29-inner-wrapper clearfix">
                                <div class="wpb-left-content">
                                    <div class="wpb-left-inner-content">
                                        ...
                                        <p class="wpb-left-content-desc animated fadeInRight"><?php echo isset($buildin_theme['buildin_popup']['wpb_subheader_text']) && !empty($buildin_theme['buildin_popup']['wpb_subheader_text']) ? esc_attr($buildin_theme['buildin_popup']['wpb_subheader_text']) : '' ?></p>
                                        <div class="wpb-theme29-cart">
                                            <div class="wpb-cart-price">
                                                <p class="cart-price-wrap animated fadeInRight">
                                                ...
                                                <a class="wpb-buy-button animated fadeInRight" href="<?php echo isset($buildin_theme['buildin_popup']['wpb_submit_button_link']) && !empty($buildin_theme['buildin_popup']['wpb_submit_button_link']) ? esc_url($buildin_theme['buildin_popup']['wpb_submit_button_link']) : ''; ?>" ><i class="fa fa-shopping-cart"></i><?php echo isset($buildin_theme['buildin_popup']['wpb_submit_text']) && !empty($buildin_theme['buildin_popup']['wpb_submit_text']) ? esc_attr($buildin_theme['buildin_popup']['wpb_submit_text']) : ''; ?></a>                                       
                                            </div>
                                        </div>
                                    </div>
                                    <div class="wpb-right-content">                                
                                        <div class="wpb-right-image-content animated fadeInRight">
                                            <?php if (isset($buildin_theme['buildin_popup']['wpb_builtin_main_image']) && !empty($buildin_theme['buildin_popup']['wpb_builtin_main_image'])) { ?>
                                                <img src="<?php echo isset($buildin_theme['buildin_popup']['wpb_builtin_main_image']) && !empty($buildin_theme['buildin_popup']['wpb_builtin_main_image']) ? esc_url($buildin_theme['buildin_popup']['wpb_builtin_main_image']) : WPP_IMAGE_DIR . '/shoes.png'; ?>">
                                            <?php } ?>
                                        </div>
                                    </div>
                                </div>
