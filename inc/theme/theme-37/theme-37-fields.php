    ...
    <div class="wpb-default-setting-group-wrapper">
        ...
        <div class="wpb-default-setting-field-wrapper" id='wpb-basic-layout-setting'>
            ...
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                ...
                <div class="wpb-input-field">
                    <input class="buildin-default-font-color" id="wpb-upload-builtin-bg-image" type="text" name="buildin_theme[wpb_builtin_bg_color]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_builtin_bg_color']); ?>">
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
                ...
                <div class="wpb-input-field">
                    <input type="text" id="wpb-header-text" name="buildin_theme[wpb_header_text]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_header_text']); ?>" placeholder="<?php echo __('Get Our Product...', 'wp-popup-lite'); ?>">
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
            ...
            <div class="wpb-input-field-wrap" id="wpb-popup-position">
                ...
                <div class="wpb-input-field">
                    <input type="text" id="wpb-popup-sub-header-text" name="buildin_theme[wpb_subheader_text]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_subheader_text']); ?>" placeholder="<?php echo __('Any Update of our theme', 'wp-popup-lite'); ?>">
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
            ...
            <div class="wpb-input-field-wrap" id="wpb-popup-background-field">
                <div class="wpb-input-field-title">
                    <label>
                        <h4><?php echo __('Coupon Code Text', 'wp-popup-lite'); ?></h4>
                    </label>
                </div>
                <div class="wpb-input-field">
                    <input type="text" id="wpb-email-label-text" name="buildin_theme[wpb_coupon_code_text]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_coupon_code_text']); ?>" placeholder="<?php echo __('55DISCOUNT', 'wp-popup-lite'); ?>">
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
            ...
            <div class="wpb-input-field-wrap" id="wpb-hidden-overlay-color-field">
                ...
                <div class="wpb-input-field">
                    <input id="wpb-email-placeholder" type="text" name="buildin_theme[wpb_name_placeholder_text]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_name_placeholder_text']); ?>" placeholder="<?php echo __('Your name..', 'wp-popup-lite'); ?>"/>
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
            ...
            <div class="wpb-input-field-wrap" id="wpb-hidden-overlay-color-field">
                ...
                <div class="wpb-input-field">
                    <input id="wpb-email-placeholder" type="text" name="buildin_theme[wpb_email_placeholder]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder']); ?>" placeholder="<?php echo __('Your email..', 'wp-popup-lite'); ?>"/>
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
            ...
            <div class="wpb-input-field-wrap" id="wpb-popup-shape">
                <div class="wpb-input-field-title">
                    <label>
                        <h4><?php echo __('Get Discount Button Text', 'wp-popup-lite') ?></h4>
                    </label>
                </div>
                <div class="wpb-input-field">
                    <input type="text" id="wpb-submit-button-text" name="buildin_theme[wpb_submit_text]" value="<?php echo esc_attr($buildin_theme['buildin_popup']['wpb_submit_text']); ?>" placeholder="<?php echo __('Get Discount', 'wp-popup-lite'); ?>">
                </div>
            </div>
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
                    <label>
                        <h4><?php echo __('Get Discount Button Text Typography', 'wp-popup-lite') ?></h4>
                    </label>
                </div>
                <div class="wpb-input-field-inner">
                    <div class="wpb-input-field">
            ...
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
                    <label>
                        <h4><?php echo __('Get Discount Button loading Text', 'wp-popup-lite') ?></h4>
                    </label>
                </div>
                <div class="wpb-input-field">
            ...
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
                    <label>
                        <h4><?php echo __('Get Discount Button Thanks Text', 'wp-popup-lite') ?></h4>
                    </label>
                </div>
                <div class="wpb-input-field">
            ...
            <div class="wpb-input-field-wrap">
                <div class="wpb-input-field-title">
                    <label>
                        <h4><?php echo __('Get Discount Success Message', 'wp-popup-lite') ?></h4>
                    </label>
                </div>
                <div class="wpb-input-field">
            ...
            <div class="wpb-input-field-wrap">
                <div class="wpb-input-field-title">
                    <label>
                        <h4><?php echo __('Get Discount Failure Message', 'wp-popup-lite') ?></h4>
                    </label>
                </div>
                <div class="wpb-input-field">
            ...
            <div class="wpb-input-field-wrap" id="wpb-basic-layout-setting">
                <div class="wpb-input-field-title">
                    <label>
                        <h4><?php echo __('Get Discount Button Background Color', 'wp-popup-lite') ?></h4>
                    </label>
                </div>
                <div class="wpb-input-field">
