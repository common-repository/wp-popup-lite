...
<div class="wpb-outer-wrap wpb-default-popup-layout wpb-<?php echo $wpb_buildin_theme_type; ?>" id="wpb-outer-wrap-<?php echo esc_attr($popup_id); ?>" data-popup-id="<?php echo esc_attr($popup_id); ?>" 
    ...
    <style type="text/css">
        ...
        <?php } ?>
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme37-wrapper{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme37-wrapper .wpb-middle-content-title{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme37-wrapper .wpb-middle-desc{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme37-wrapper input.wpb-name-field{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme37-wrapper input.wpb-email-field{
            -webkit-animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 0.5) : 1.5; ?>s; /* Safari 4.0 - 8.0 */
            animation-delay: <?php echo!empty($wpb_popup_animate_delay) ? esc_attr($wpb_popup_animate_delay + 0.5) : 1.5; ?>s;
            animation-duration:1s; 
            -webkit-animation-duration: 1s; /* Safari 4.0 - 8.0 */
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme37-wrapper .wpb-theme37-form input[type="text"].wpb-name-field::-moz-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme37-wrapper .wpb-theme37-form input[type="text"].wpb-name-field{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme37-wrapper .wpb-theme37-form input[type="text"].wpb-name-field:-ms-input-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme37-wrapper .wpb-theme37-form input[type="text"].wpb-name-field{
            font-family:<?php echo isset($buildin_theme['buildin_popup']['wpb_name_placeholder_typography']) && !empty($buildin_theme['buildin_popup']['wpb_name_placeholder_typography']) ? esc_attr($buildin_theme['buildin_popup']['wpb_name_placeholder_typography']) : ''; ?>;
            color:<?php echo isset($buildin_theme['buildin_popup']['wpb_name_placeholder_font_color']) && !empty($buildin_theme['buildin_popup']['wpb_name_placeholder_font_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_name_placeholder_font_color']) . '!important' : ''; ?>;
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme37-wrapper .wpb-theme37-form input[type="text"].wpb-name-field::-webkit-input-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme37-wrapper .wpb-theme37-form input[type="text"].wpb-name-field{
            font-family:<?php echo isset($buildin_theme['buildin_popup']['wpb_name_placeholder_typography']) && !empty($buildin_theme['buildin_popup']['wpb_name_placeholder_typography']) ? esc_attr($buildin_theme['buildin_popup']['wpb_name_placeholder_typography']) : ''; ?>;
            color:<?php echo isset($buildin_theme['buildin_popup']['wpb_name_placeholder_font_color']) && !empty($buildin_theme['buildin_popup']['wpb_name_placeholder_font_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_name_placeholder_font_color']) . '!important' : ''; ?>;
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme37-wrapper .wpb-theme37-form input[type="text"].wpb-email-field::-moz-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme37-wrapper .wpb-theme37-form input[type="text"].wpb-email-field{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme37-wrapper .wpb-theme37-form input[type="text"].wpb-email-field:-ms-input-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme37-wrapper .wpb-theme37-form input[type="text"].wpb-email-field{
            font-family:<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) : ''; ?>;
            color:<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) . '!important' : ''; ?>;
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme37-wrapper .wpb-theme37-form input[type="text"].wpb-email-field::-webkit-input-placeholder,
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme37-wrapper .wpb-theme37-form input[type="text"].wpb-email-field{
            font-family:<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder_typography']) : ''; ?>;
            color:<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder_font_color']) . '!important' : ''; ?>;
        }
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme37-wrapper .wpb-discount-button{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme37-wrapper .wpb-dis-button2{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme-37 .wpb_close_btn.wpb-close-option:after{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme-37 .wpb_close_btn.wpb-close-option{
        ...
        .wpb-main-wrapper-<?php echo $parameteres['popup_parameters']['popup_random_val']; ?> .wpb-theme37-wrapper .wpb-fe-form-field.required.wpb-input-field-error{
        ...
        <div class="wpb-main-inner-wrap animated <?php echo $wpb_popup_animation_option; ?>">
            ...
            <div class="wpb-inner-wrapper" style="position:relative;"> 
                <div class="wpb-popup-content">
                    ...
                    ?>">
                        <div class="wpb-theme37-wrapper">
                            <div class="wpb-theme37-inner-wrapper clearfix">
                                <div class="wpb-middle-content">
                                    <div class="wpb-middle-inner-content">
                                        <p class="wpb-middle-content-title animated fadeInDown">
                                        ...
                                        <p class="wpb-middle-desc animated fadeInDown"><?php echo isset($buildin_theme['buildin_popup']['wpb_subheader_text']) && !empty($buildin_theme['buildin_popup']['wpb_subheader_text']) ? esc_attr($buildin_theme['buildin_popup']['wpb_subheader_text']) : ''; ?></p> 
                                        <div class="wpb-theme37-form">
                                            <div class="wpb-middle-input-field">
                                                <span class="wpb-discount-button animated fadeInDown"><i class="fa fa-scissors"></i><?php echo isset($buildin_theme['buildin_popup']['wpb_coupon_code_text']) && !empty($buildin_theme['buildin_popup']['wpb_coupon_code_text']) ? esc_attr($buildin_theme['buildin_popup']['wpb_coupon_code_text']) : '' ?></span>                                        
                                                <div class="wpb-name-field animated fadeInUp">
                                                    <input class="wpb-text-field wpb-name-field wpb-fe-form-field <?php
                                                ...
                                                <div class="wpb-email-field animated fadeInUp">
                                                    <input class="wpb-text-field wpb-email-field wpb-fe-form-field required" type="text" name="wpb_email_address" placeholder="<?php echo isset($buildin_theme['buildin_popup']['wpb_email_placeholder']) && !empty($buildin_theme['buildin_popup']['wpb_email_placeholder']) ? esc_attr($buildin_theme['buildin_popup']['wpb_email_placeholder']) : ''; ?>">
                                                </div>                                              
                                                <button type="submit" class="wpb-dis-button2 wpb-subscribe-button animated fadeInUp <?php
